...
public enum ErrorCode {
    ...
    AUTH_PASSWORD_CHANGE_REQUIRED("AUTH_PASSWORD_CHANGE_REQUIRED", "请先修改密码后再继续操作"),
    AUTH_CURRENT_PASSWORD_INCORRECT("AUTH_CURRENT_PASSWORD_INCORRECT", "当前密码不正确"),
    ...
    DESTRUCTION_NOT_FOUND("DESTRUCTION_NOT_FOUND", "销毁记录不存在"),
    DESTRUCTION_BATCH_NOT_FOUND("DESTRUCTION_BATCH_NOT_FOUND", "批次不存在或已无法销毁"),
    DESTRUCTION_INSUFFICIENT_STOCK("DESTRUCTION_INSUFFICIENT_STOCK", "批次剩余库存不足，无法销毁"),
    DESTRUCTION_STOCK_CONFLICT("DESTRUCTION_STOCK_CONFLICT", "批次库存已被其他操作更新，请重试"),
